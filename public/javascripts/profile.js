...
$(document).ready(function() {    
    ...
    if(friends != null){
        for(var i = 0; i < friends.length;i++){
            $('#FList').append('<a href ="/users/'+friends[i]+'"><li class="friend" id="friend['+i+']"><img class = "friendsAvatars" src="'+friendsAvatars[i]+'"><span class = "FLNAME">'+friends[i]+'</span><img class = "friendsOnline" src="'+(friendsOnline[i]?"/images/profile/online.png":"/images/profile/offline.png")+'"></li></a>');
